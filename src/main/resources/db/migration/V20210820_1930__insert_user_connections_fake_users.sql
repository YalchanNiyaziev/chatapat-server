...
((SELECT id from chat_users where username = 'fakeOne1'), (SELECT id from chat_users where username = 'fakeOne'), false, true, false, '2021-08-20T18:00:11.712942Z', 'fakeOne'),
((SELECT id from chat_users where username = 'fakeOne2'), (SELECT id from chat_users where username = 'fakeOne'), false, true, false, '2021-08-20T18:00:11.712942Z', 'fakeOne'),
((SELECT id from chat_users where username = 'fakeOne3'), (SELECT id from chat_users where username = 'fakeOne'), false, true, false, '2021-08-20T18:00:11.712942Z', 'fakeOne'),
((SELECT id from chat_users where username = 'fakeOne4'), (SELECT id from chat_users where username = 'fakeOne'), false, true, false, '2021-08-20T18:00:11.712942Z', 'fakeOne'),
((SELECT id from chat_users where username = 'fakeOne5'), (SELECT id from chat_users where username = 'fakeOne'), false, true, false, '2021-08-20T18:00:11.712942Z', 'fakeOne'),
((SELECT id from chat_users where username = 'fakeOne6'), (SELECT id from chat_users where username = 'fakeOne'), false, true, false, '2021-08-20T18:00:11.712942Z', 'fakeOne'),
((SELECT id from chat_users where username = 'fakeOne7'), (SELECT id from chat_users where username = 'fakeOne'), false, true, false, '2021-08-20T18:00:11.712942Z', 'fakeOne'),
((SELECT id from chat_users where username = 'fakeOne8'), (SELECT id from chat_users where username = 'fakeOne'), false, true, false, '2021-08-20T18:00:11.712942Z', 'fakeOne'),
((SELECT id from chat_users where username = 'fakeOne9'), (SELECT id from chat_users where username = 'fakeOne'), false, true, false, '2021-08-20T18:00:11.712942Z', 'fakeOne'),
((SELECT id from chat_users where username = 'fakeOne10'), (SELECT id from chat_users where username = 'fakeOne'), false, true, false, '2021-08-20T18:00:11.712942Z', 'fakeOne'),
((SELECT id from chat_users where username = 'fakeOne11'), (SELECT id from chat_users where username = 'fakeOne'), false, true, false, '2021-08-20T18:00:11.712942Z', 'fakeOne'),
((SELECT id from chat_users where username = 'fakeOne12'), (SELECT id from chat_users where username = 'fakeOne'), false, true, false, '2021-08-20T18:00:11.712942Z', 'fakeOne'),
((SELECT id from chat_users where username = 'fakeOne13'), (SELECT id from chat_users where username = 'fakeOne'), false, true, false, '2021-08-20T18:00:11.712942Z', 'fakeOne'),
((SELECT id from chat_users where username = 'fakeOne14'), (SELECT id from chat_users where username = 'fakeOne'), false, true, false, '2021-08-20T18:00:11.712942Z', 'fakeOne'),
((SELECT id from chat_users where username = 'fakeOne15'), (SELECT id from chat_users where username = 'fakeOne'), false, true, false, '2021-08-20T18:00:11.712942Z', 'fakeOne'),
...
INSERT INTO chat_user_x_conversation(user_id, conversation_id) VALUES
    ((SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ((SELECT id from chat_users where username = 'fakeOne1'), (SELECT * FROM inserment1))
    )
INSERT INTO chat_conversation_messages(message_type, content, message_ts, message_status, sender_id, conversation_id) VALUES
...
INSERT INTO chat_user_x_conversation(user_id, conversation_id) VALUES
    ((SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ((SELECT id from chat_users where username = 'fakeOne2'), (SELECT * FROM inserment1))
    )
INSERT INTO chat_conversation_messages(message_type, content, message_ts, message_status, sender_id, conversation_id) VALUES
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
...
INSERT INTO chat_user_x_conversation(user_id, conversation_id) VALUES
    ((SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ((SELECT id from chat_users where username = 'fakeOne3'), (SELECT * FROM inserment1))
    )
INSERT INTO chat_conversation_messages(message_type, content, message_ts, message_status, sender_id, conversation_id) VALUES
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
...
INSERT INTO chat_user_x_conversation(user_id, conversation_id) VALUES
    ((SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ((SELECT id from chat_users where username = 'fakeOne4'), (SELECT * FROM inserment1))
    )
INSERT INTO chat_conversation_messages(message_type, content, message_ts, message_status, sender_id, conversation_id) VALUES
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
...
INSERT INTO chat_user_x_conversation(user_id, conversation_id) VALUES
    ((SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ((SELECT id from chat_users where username = 'fakeOne5'), (SELECT * FROM inserment1))
    )
INSERT INTO chat_conversation_messages(message_type, content, message_ts, message_status, sender_id, conversation_id) VALUES
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
...
INSERT INTO chat_user_x_conversation(user_id, conversation_id) VALUES
    ((SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ((SELECT id from chat_users where username = 'fakeOne6'), (SELECT * FROM inserment1))
    )
INSERT INTO chat_conversation_messages(message_type, content, message_ts, message_status, sender_id, conversation_id) VALUES
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
...
INSERT INTO chat_user_x_conversation(user_id, conversation_id) VALUES
    ((SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ((SELECT id from chat_users where username = 'fakeOne7'), (SELECT * FROM inserment1))
    )
INSERT INTO chat_conversation_messages(message_type, content, message_ts, message_status, sender_id, conversation_id) VALUES
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
...
INSERT INTO chat_user_x_conversation(user_id, conversation_id) VALUES
    ((SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ((SELECT id from chat_users where username = 'fakeOne8'), (SELECT * FROM inserment1))
    )
INSERT INTO chat_conversation_messages(message_type, content, message_ts, message_status, sender_id, conversation_id) VALUES
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
...
INSERT INTO chat_user_x_conversation(user_id, conversation_id) VALUES
    ((SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ((SELECT id from chat_users where username = 'fakeOne9'), (SELECT * FROM inserment1))
    )
INSERT INTO chat_conversation_messages(message_type, content, message_ts, message_status, sender_id, conversation_id) VALUES
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
...
INSERT INTO chat_user_x_conversation(user_id, conversation_id) VALUES
    ((SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ((SELECT id from chat_users where username = 'fakeOne10'), (SELECT * FROM inserment1))
    )
INSERT INTO chat_conversation_messages(message_type, content, message_ts, message_status, sender_id, conversation_id) VALUES
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
...
INSERT INTO chat_user_x_conversation(user_id, conversation_id) VALUES
    ((SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ((SELECT id from chat_users where username = 'fakeOne11'), (SELECT * FROM inserment1))
    )
INSERT INTO chat_conversation_messages(message_type, content, message_ts, message_status, sender_id, conversation_id) VALUES
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
...
INSERT INTO chat_user_x_conversation(user_id, conversation_id) VALUES
    ((SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ((SELECT id from chat_users where username = 'fakeOne12'), (SELECT * FROM inserment1))
    )
INSERT INTO chat_conversation_messages(message_type, content, message_ts, message_status, sender_id, conversation_id) VALUES
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
...
INSERT INTO chat_user_x_conversation(user_id, conversation_id) VALUES
    ((SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ((SELECT id from chat_users where username = 'fakeOne13'), (SELECT * FROM inserment1))
    )
INSERT INTO chat_conversation_messages(message_type, content, message_ts, message_status, sender_id, conversation_id) VALUES
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
...
INSERT INTO chat_user_x_conversation(user_id, conversation_id) VALUES
    ((SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ((SELECT id from chat_users where username = 'fakeOne14'), (SELECT * FROM inserment1))
    )
INSERT INTO chat_conversation_messages(message_type, content, message_ts, message_status, sender_id, conversation_id) VALUES
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
    ('TEXT', 'Hello friend', '2021-08-20T18:10:11.712942Z', 'DELIVERED', (SELECT id from chat_users where username = 'fakeOne'), (SELECT * FROM inserment1)),
